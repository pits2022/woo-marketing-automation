...
class WMA_Admin {
	...
	public static function handle_test_email(): void {
		...
		$data = [
			...
			'review_products'              => '<table style="width:100%;border-collapse:collapse;margin-bottom:24px;"><thead><tr><th style="padding:8px;border-bottom:2px solid #ddd;font-size:inherit;"></th><th style="padding:8px;text-align:left;border-bottom:2px solid #ddd;font-size:inherit;">Megvásárolt termékek</th></tr></thead><tbody><tr><td style="padding:8px;border-bottom:1px solid #eee;width:70px;font-size:inherit;"></td><td style="padding:8px;border-bottom:1px solid #eee;font-size:inherit;"><a href="#tab-reviews" style="color:' . esc_attr( $base_color ) . ';text-decoration:none;font-weight:bold;">Test Product 1</a></td></tr><tr><td style="padding:8px;border-bottom:1px solid #eee;width:70px;font-size:inherit;"></td><td style="padding:8px;border-bottom:1px solid #eee;font-size:inherit;"><a href="#tab-reviews" style="color:' . esc_attr( $base_color ) . ';text-decoration:none;font-weight:bold;">Test Product 2</a></td></tr></tbody></table>',
			'discount_products'            => '<table style="width:100%;border-collapse:collapse;"><thead><tr><th style="padding:8px;border-bottom:2px solid #ddd;font-size:inherit;"></th><th style="padding:8px;text-align:left;border-bottom:2px solid #ddd;font-size:inherit;">Akciós termékek</th><th style="padding:8px;text-align:left;border-bottom:2px solid #ddd;font-size:inherit;">Regular</th><th style="padding:8px;text-align:left;border-bottom:2px solid #ddd;font-size:inherit;">Sale</th><th style="padding:8px;text-align:left;border-bottom:2px solid #ddd;font-size:inherit;">Discount</th></tr></thead><tbody><tr><td style="padding:8px;border-bottom:1px solid #eee;width:70px;font-size:inherit;"></td><td style="padding:8px;border-bottom:1px solid #eee;font-size:inherit;"><a href="#" style="color:' . esc_attr( $base_color ) . ';text-decoration:none;font-weight:bold;">Test Sale Product</a></td><td style="padding:8px;border-bottom:1px solid #eee;text-decoration:line-through;color:#999;font-size:inherit;">$20.00</td><td style="padding:8px;border-bottom:1px solid #eee;color:#c00;font-weight:bold;font-size:inherit;">$15.00</td><td style="padding:8px;border-bottom:1px solid #eee;font-size:inherit;"><span style="background:#c00;color:#fff;padding:2px 6px;border-radius:3px;font-size:12px;">-25%</span></td></tr></tbody></table>',
